...
pdftitle = {Pratiques et réflexions autour de l'édition numérique de sources anciennes et de ses outils : l'exemple du projet Dyrin, programme de recherche sur la faune du Grand Nord},
...
pdfkeywords = {Dyrin} {recherche} {sciences-humaines} {PDN} {CRAHAM} {Caen} {XML} {TEI} {BaseX} {faune} {arctique} {scandinavie} {MaX} {edition} {numerique} {FAIR} {environnement} {métadonnées}}
...
\nocite{*}
\defbibnote{intro}{La bibliographie suivante est classée en trois catégories : Sciences-humaines et sociales, Numérique/informatique et Ecologie/environnement. Les références dans chaque partie sont regroupées en fonction de leur statut : ouvrage ou article en ligne.}
...
\defbibnote{intro}{Cette bibliographie contient les travaux principaux au coeur du projet, suivis d'une classification des sources annexes en trois thèmes : sciences humaines et sociales (SHS), numérique et développement, écologie et environnement.}
